public class Main {
    ...
    public static String encryption(String text, String key, char operation) {
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            pointer++;
            if (pointer == key.length()) pointer = 0; // To prevent the pointer from pointing outside the keys.

            encryptionText[i] = (char) ((ascii + 97)); // Adds the correct ASCII value as a character to the array.
        }
